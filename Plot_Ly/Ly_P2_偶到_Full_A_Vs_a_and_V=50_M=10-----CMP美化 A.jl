...
data = hcat(data_arrive2,data_arrive3)#, data_arrive4, data_arrive6, data_arrive8)#, data_arrive10, data_arrive12,data_arrive14,data_arrive16)
Marker_Size = 2
Line_Width=2
...
xlabel("任务到达速率\$\\lambda\$", fontsize = 8)
...
legend(fontsize = 8)
# size(500,100)
savefig(plotsdir("Ly_final_比较图9.png"), bbox_inches = "tight", dpi=1200)
